...
import { getDisplayInfo, getEditableStatus } from "../../utils/attendStatus";
...
const UserAttendStatusEditor = ({ programId }: UserAttendStatusEditorProps) => {
  const {
    userAttendStatusInfo: { name, attendStatus },
    isLoading,
    programType,
    programStatus,
...
export default UserAttendStatusEditor;
